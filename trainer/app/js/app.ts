...
import { DescriptionPanelComponent } from './7minworkout/description-panel-component';
import { WorkoutAudioComponent } from './7minworkout/workout-audio-component';
import { WorkoutComponent } from './7minworkout/workout-component';
...
angular.module('7minWorkout').directive('descriptionPanel', upgradeAdapter.downgradeNg2Component(DescriptionPanelComponent) as angular.IDirectiveFactory);
angular.module('7minWorkout').directive('workoutAudio', upgradeAdapter.downgradeNg2Component(WorkoutAudioComponent) as angular.IDirectiveFactory);
angular.module('7minWorkout').directive('workout', upgradeAdapter.downgradeNg2Component(WorkoutComponent) as angular.IDirectiveFactory);
